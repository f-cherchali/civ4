<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.8.2.defe0e4.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.8.2.defe0e4' . $minify_or_not . '.js');
