...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?=site_url("admin/logout")?>" role="button">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="<?=site_url("assets/img/adminpanellogo.jpg")?>"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">App customer name</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          {if $admin_photo==""}
            <img src="<?=site_url("assets/img/defaultuser.png")?>" class="img-circle elevation-2" alt="{admin_first_name} {admin_last_name}">
          {else}
            <img src="<?=site_url("assets/img/{admin_photo}")?>" class="img-circle elevation-2" alt="{admin_first_name} {admin_last_name}">
          {endif}
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?=date("Y")?> <a href="#">APP DEV NAME</a>.</strong> All rights
    reserved.
  </footer>
